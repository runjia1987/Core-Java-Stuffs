...
public class MVEL_Test {
	...
	public void propertyBeanExpression (){
		Serializable PropertyExpression1 = MVEL.compileExpression("this.getName().toString()");
		// this.name.toString()
	...
	public void defFunctionExpression() {
		...
		VariableResolverFactory methodFactory = new MapVariableResolverFactory();
		methodFactory.setNextFactory(varFactory);
